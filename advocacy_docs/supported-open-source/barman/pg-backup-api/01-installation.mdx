...
Official Debian packages for Postgres backup API are distributed by EnterpriseDB and made available through the EDB [public APT repositories](https://www.enterprisedb.com/repos-downloads).
...
Official RPM packages for Postgres backup API are distributed by EnterpriseDB and made available through the EDB [public YUM repositories](https://www.enterprisedb.com/repos-downloads).
The required repository can be enabled by following the instructions at that website.
...
Postgres backup API packages for SLES are distributed by EnterpriseDB and made available through the EDB [public zypper repositories](https://www.enterprisedb.com/repos-downloads).
The required repository can be enabled by following the instructions at that website.
